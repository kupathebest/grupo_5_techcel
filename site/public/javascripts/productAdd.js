...
window.addEventListener('load', () => {
    ...
    $('shortName').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('displayP').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('processorP').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('memoryP').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('storageP').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('expansionP').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('cameraP').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('batteryP').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('profileP').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('weightP').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('bluetooth').addEventListener('keyup', () => {
        switch (true) {
    ...
    $('formulario-add').addEventListener('submit', event => {
        ...
        let elementosForm = $('formulario-add').elements;
